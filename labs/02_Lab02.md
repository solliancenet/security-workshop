...
5. Upload the `Azure Sentinel ML.ipynb` file
...
2. Select **Run**, follow each of the cells as they are executed.  Some will prompt you for data such as the API keys:
